...
import com.example.instagram_clone_try3.data.PostsRepository
import com.example.instagram_clone_try3.data.StoriesRepository
import com.example.instagram_clone_try3.data.Story
import com.example.instagram_clone_try3.ui.PostView
import com.example.instagram_clone_try3.ui.StoryImage
    ...
    LazyRow {//지연 row형식으로 
        itemsIndexed(stories) { index, story ->//각 스토리들을 index와 함께 가져와서
            ...
            Column(//세로로 사진과 여백과 아이디가 떠야하나 column
                ...
                Text(story.name, style = androidx.compose.material.MaterialTheme.typography.caption)
                //닉네임 출력
            }
